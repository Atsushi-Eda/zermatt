...
?>
  <div id="maincontents">
    <div id="pankuzu">
      <a href="../../../">TOP</a> > <a href="../../">管理ページTOP</a> > <a href="../">ギャラリー管理</a> > AWアルバム管理
    </div>
    <?= flash_message() ?>
    <h2>AWアルバム管理</h2>
...
<?php
  foreach(scandir($dir . $album['id'] . "/") as $file){
    if($file=="." || $file==".."){
      continue;
    }
?>
                <div class="album_img"><?= readImg($dir . $album['id'] . "/" . $file) ?></div>
<?php
  }
?>
              </div>
