...
?>
  <div id="maincontents">
    <div id="pankuzu">
      <a href="../../../">TOP</a> > <a href="../../">2年用管理ページTOP</a> > <a href="../">企画管理</a> > <a href="./">アンケート結果</a> > 詳細表示
    </div>
    <?= flash_message() ?>
    <h2>企画アンケート結果詳細表示</h2>
...
$(function(){
  ...
  $("#event_id").change(function(){
    location.href = "http://<?= ROOT_DIR ?>/for_members/admin2/event/questionnaire/view.php?event_id="+$(this).val();
  });
});
</script>
</body>
